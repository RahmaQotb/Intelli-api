...
@section('title')
    Add Admin for {{ $brand->name }} - Intellij
@endsection

@section('content')
<form method="POST" action="{{ route('dashboard.brands.admin.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex mt-4 justify-content-center">
                    ...
                    <a href="{{ route('dashboard.index') }}" class="btn btn-secondary ms-2">Cancel</a>
                </div>
            </div>
        </div>
    </section>
