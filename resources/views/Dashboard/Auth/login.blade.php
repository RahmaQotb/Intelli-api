...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                {{-- <a href=""><img src="{{asset('images/')}}" style="height: 100%; width:100%" alt="logo" ></a> --}}
            </div>
            ...
            <form method="POST" action="{{ route('dashboard.auth.login') }}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" autocomplete="off" name="email" class="form-control form-control-xl" placeholder="Email">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="guard" id="admin" value="admin" required>
        <label class="form-check-label" for="admin">Admin</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="guard" id="brand_admin" value="brand_admin">
        <label class="form-check-label" for="brand_admin">Brand Admin</label>
    </div>
</div>
